...
router.post('/addproduct', upload.single('productImg'), verifyToken, (req, res) => {
...
router.post('/editProduct', upload.single('productImg'), verifyToken, (req, res) => {
